  ...
  return (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
    children: [(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxDEV)(_storybook_addon_docs__WEBPACK_IMPORTED_MODULE_2__.Meta, {
      ...
      children: (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxDEV)(_components.code, {
        ...
        children: "export function MyComponent() {\r\n  const t = useI18nMessage();\r\n\r\n  return (\r\n    <HubCard pad={['2', '4']}>\r\n      <HubText typo=\"h1\">{t('detalhes-pagamentos_files-arquivos')}</HubText>\r\n\r\n      <HubText typo=\"h1\">{t('detalhes-pagamentos_files-andamento')}</HubText>\r\n\r\n      <HubText typo=\"h1\">{t('detalhes-pagamentos_files-historico')}</HubText>\r\n\r\n      <HubText typo=\"h1\">{t('detalhes-pagamentos_files-imposto')}</HubText>\r\n    </HubCard>\r\n  );\r\n}\n"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 13,
        columnNumber: 1
      ...
      children: (0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxDEV)(_components.code, {
        className: "language-typescript",
        children: "it('Should be able renders component with correct texts', () => {\r\n  const renderComponent = (props?: Partial<YourComponentProps>) => {\r\n    return render(<YourComponent {...defaultProps} {...props} />, {\r\n      wrapper: wrapse(ThemeProvider, I18nProvider)\r\n    });\r\n  };\r\n\r\n  const { getByText } = renderComponent();\r\n\r\n  expect(getByText('detalhes-pagamentos_files-arquivos')).toBeInTheDocument();\r\n  expect(getByText('detalhes-pagamentos_files-detalhes')).toBeInTheDocument();\r\n  expect(getByText('detalhes-pagamentos_files-andamento')).toBeInTheDocument();\r\n  expect(getByText('detalhes-pagamentos_files-imposto')).toBeInTheDocument();\r\n});\n"
      }, undefined, false, {
        fileName: "<source.js>",
        lineNumber: 31,
        columnNumber: 1
...
//# sourceMappingURL=main.4bc1846c6692a1da2045.hot-update.js.map