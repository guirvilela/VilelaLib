...
var fadein = styledComponents.keyframes(["from{opacity:0;}to{opacity:1;}"]);
var fadeout = styledComponents.keyframes(["from{opacity:1;}to{opacity:0;}"]);
var spin = styledComponents.keyframes(["from{transform:rotate(0deg);}to{transform:rotate(360deg);}"]);
var indeterminate = styledComponents.keyframes(["0%{transform:translateX(0) scaleX(0);}40%{transform:translateX(0) scaleX(0.4);}100%{transform:translateX(100%) scaleX(0.5);}"]);
var shimmer = styledComponents.keyframes(["100%{transform:translateX(100%);}"]);
var growup = function growup(percent) {
  return styledComponents.keyframes(["from{width:0%;}to{width:", "%;}"], percent || 100);
};
var blink = styledComponents.keyframes(["0%{background-color:inherit;}20%{background-color:#FFE9C8;}100%{background-color:inherit;}"]);
...
var breakpoints = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, exports.Breakpoint.xs, '480px'), exports.Breakpoint.sm, '576px'), exports.Breakpoint.md, '768px'), exports.Breakpoint.lg, '992px'), exports.Breakpoint.xl, '1200px'), exports.Breakpoint.xxl, '1600px');
...
function useResponsive() {
  ...
  var isMobile = React__default["default"].useMemo(function () {
    return breakpoint ? [exports.Breakpoint.xs, exports.Breakpoint.md, exports.Breakpoint.sm, exports.Breakpoint.md].includes(breakpoint) : false;
  }, [breakpoint]);
  var isDesktop = React__default["default"].useMemo(function () {
    return breakpoint ? [exports.Breakpoint.lg, exports.Breakpoint.xl, exports.Breakpoint.xxl].includes(breakpoint) : false;
  }, [breakpoint]);
  var isLargeDesktop = React__default["default"].useMemo(function () {
    return breakpoint === exports.Breakpoint.xxl;
  }, [breakpoint]);
  var isBreakpoint = React__default["default"].useCallback(function (v) {
    return breakpoint === v;
  }, [breakpoint]);
  var updateBreakpoint = React__default["default"].useCallback(function () {
    if (windowSize.width <= parsePixel(breakpoints.sm)) {
      setBreakPoint(exports.Breakpoint.xs);
    } else if (windowSize.width <= parsePixel(breakpoints.md)) {
      setBreakPoint(exports.Breakpoint.sm);
    } else if (windowSize.width <= parsePixel(breakpoints.lg)) {
      setBreakPoint(exports.Breakpoint.md);
    } else if (windowSize.width <= parsePixel(breakpoints.xl)) {
      setBreakPoint(exports.Breakpoint.lg);
    } else if (windowSize.width <= parsePixel(breakpoints.xxl)) {
      setBreakPoint(exports.Breakpoint.xl);
    } else {
      setBreakPoint(exports.Breakpoint.xxl);
    }
  }, [windowSize]);
...
function withLayout(LayoutElement, layoutProps) {
  return function (Component) {
    return /*#__PURE__*/React__default["default"].memo(function Layout(props) {
      return (
        /*#__PURE__*/
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        React__default["default"].createElement(LayoutElement, layoutProps, /*#__PURE__*/React__default["default"].createElement(Component, props))
      );
    });
  };
}
...
/** @ignore */
var ThemeGlobals = styledComponents.createGlobalStyle(["html{overflow-x:hidden;scroll-behavior:smooth;}body{font-family:", ";font-size:", ";line-height:", ";letter-spacing:", ";font-weight:400;position:relative;min-height:", ";background-color:", ";color:", ";@media (", "){font-family:", ";font-size:", ";line-height:", ";letter-spacing:", ";}}"], function (_ref) {
...
var ThemeProvider = function ThemeProvider(_ref) {
  ...
  var _React$useState = React__default["default"].useState(configs === null || configs === void 0 ? void 0 : configs.customTheme),
    _React$useState2 = _slicedToArray(_React$useState, 2),
    customTheme = _React$useState2[0],
    setCustomTheme = _React$useState2[1];
  var changeTheme = React__default["default"].useCallback(function (v) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(styledComponents.ThemeProvider, {
    theme: value
  }, (configs === null || configs === void 0 ? void 0 : configs.withGlobals) && /*#__PURE__*/React__default["default"].createElement(ThemeGlobals, configs), children);
};
...
var useTheme = function useTheme() {
  return React__default["default"].useContext(styledComponents.ThemeContext);
};

exports.ThemeProvider = ThemeProvider;
exports.addAlphaHex = addAlphaHex;
exports.align = align;
...
exports.colorLevels = colorLevels;
exports.colors = colors;
exports.colorsList = colorsList;
...
exports.parsePixel = parsePixel;
exports.position = position;
exports.positionExtra = positionExtra;
exports.randomColor = randomColor;
exports.randomColorLevel = randomColorLevel;
exports.resize = resize;
exports.shadows = shadows;
exports.shadowsList = shadowsList;
exports.size = size;
exports.sort = sort;
...
exports.type = type;
exports.typoList = typoList;
exports.typography = typography;
exports.useResponsive = useResponsive;
exports.useTheme = useTheme;
exports.variant = variant;
exports.weightList = weightList;
