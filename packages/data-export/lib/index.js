...
function exportExcel(name, content, header) {
  var result = contentToCsv(content, header);
  shared.downloadFromByteArray(result, "".concat(name, ".xls"));
}
...
exports.ExportImageType = void 0;
...
})(exports.ExportImageType || (exports.ExportImageType = {}));
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ext = '';
          _context2.t0 = type;
          _context2.next = _context2.t0 === exports.ExportImageType.PNG ? 8 : _context2.t0 === exports.ExportImageType.BLOB ? 11 : _context2.t0 === exports.ExportImageType.SVG ? 13 : 16;
          break;
        case 8:
        ...
        case 19:
          return _context2.abrupt("return", transform(el, _objectSpread2({
            ...
            if (type === exports.ExportImageType.BLOB) {
              return shared.downloadFromBlob(url, name);
            }
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 7;
          return exportImage(name, el, exports.ExportImageType.PNG);
        case 7:
          document.body.removeChild(el);
        case 8:
        case "end":
...
exports.ExportPDFTableUtils = ExportPDFTableUtils;
exports.exportCSV = exportCSV;
exports.exportExcel = exportExcel;
exports.exportImage = exportImage;
exports.exportPDF = exportPDF;
exports.exportQrCode = exportQrCode;
