import { HubGrid, HubAvatar, HubTooltip, HubButton, HubIcon, HubPopover, HubList, HubListItem, HubTextField } from '@hubert/atoms';
import { useI18nMessage } from '@hubert/i18n';
import { HubWebCam, HubModalAlert } from '@hubert/molecules';
import { getInitials, uploadFile, factoryTestId } from '@hubert/shared';
...
function HubPhotoUpload(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(HubGrid, {
    position: "relative",
    width: size ? parsePixel(size) + 20 + 'px' : '124px',
    align: "center"
  }, /*#__PURE__*/React.createElement(HubAvatar, _extends({
    src: src,
    initials: getInitials(name),
    size: size || '104px',
    typo: "h3"
  }, props)), !disabled && /*#__PURE__*/React.createElement(HubGrid, {
    row: true,
    position: "absolute",
    align: "center",
    justify: "end",
    inset: ['', '', '0', '']
  }, /*#__PURE__*/React.createElement(HubTooltip, {
  ...
  }))))), /*#__PURE__*/React.createElement(HubPopover, {
    source: menuRef,
    onClose: setMenuRef,
    width: "240px",
    autoClose: true,
    content: /*#__PURE__*/React.createElement(HubList, {
      hover: true
    }, !hideUpload && /*#__PURE__*/React.createElement(HubListItem, null, /*#__PURE__*/React.createElement(HubButton, {
      variant: "ghost",
      noPadding: true,
      onClick: /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return uploadFile(false, '.jpg,.jpeg,.png');
            case 2:
    ...
    }), t('hub-photo-upload_upload'))), !hideWebCam && /*#__PURE__*/React.createElement(HubListItem, null, /*#__PURE__*/React.createElement(HubButton, {
      variant: "ghost",
      noPadding: true,
  ...
  }), !hideWebCam && /*#__PURE__*/React.createElement(HubWebCam, {
    opened: showCamera,
    videoSize: videoSize,
...
export { HubPhotoUpload, HubYesNo };
