...
var I18nContext = /*#__PURE__*/React__default["default"].createContext(null);
...
var useI18n = function useI18n() {
  return React__default["default"].useContext(I18nContext);
};
/** Objeto com as configurações obrigatorias do i18n */
var i18nDefaults = {
  initLocale: exports.Locale.PT_BR,
  timezone: _defineProperty(_defineProperty({}, exports.Locale.EN_US, exports.Timezone.EN_US), exports.Locale.PT_BR, exports.Timezone.PT_BR),
  currency: _defineProperty(_defineProperty({}, exports.Locale.EN_US, exports.Currency.EN_US), exports.Locale.PT_BR, exports.Currency.PT_BR),
  langs: _defineProperty(_defineProperty({}, exports.Locale.EN_US, enUS), exports.Locale.PT_BR, ptBR)
};
...
function I18nProvider(_ref) {
  ...
  var _React$useState = React__default["default"].useState(config.initLocale),
    _React$useState2 = _slicedToArray(_React$useState, 2),
    locale = _React$useState2[0],
    setLocale = _React$useState2[1];
  var _React$useState3 = React__default["default"].useState(config.currency[locale]),
    _React$useState4 = _slicedToArray(_React$useState3, 2),
    currency = _React$useState4[0],
    setCurrency = _React$useState4[1];
  var _React$useState5 = React__default["default"].useState(config.timezone[locale]),
    _React$useState6 = _slicedToArray(_React$useState5, 2),
    timezone = _React$useState6[0],
    setTimezone = _React$useState6[1];
  var _React$useState7 = React__default["default"].useState(config.langs[locale]),
  ...
  return /*#__PURE__*/React__default["default"].createElement(I18nContext.Provider, {
    value: value
  }, children);
}
...
function withI18n(v) {
  return function (Component) {
    return /*#__PURE__*/React__default["default"].memo(function Access(props) {
...
function useI18nFormatter() {
  ...
  var dtf = React__default["default"].useCallback(function (v, options) {
    if (shared.isDateEmpty(v)) {
      return '';
    }
    return new Intl.DateTimeFormat(locale, _objectSpread2({}, options)).format(shared.parseDate(v));
  }, [locale]);
  var nf = React__default["default"].useCallback(function (v, options) {
    return new Intl.NumberFormat(locale, options).format(shared.parseNumber(v));
  }, [locale]);
...
function useI18nMessage() {
  var i18n = useI18n();
  var fn = React__default["default"].useCallback(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function (key, values) {
    var _i18n$messages;
    ...
    for (var _i = 0, _Object$keys = Object.keys(values); _i < _Object$keys.length; _i++) {
      ...
      result = shared.replaceAll(result, "{".concat(k, "}"), values[k]);
    }
    return result;
  }, [i18n]);
  var render = React__default["default"].useCallback(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function (key, values) {
...
exports.useI18nFormatter = useI18nFormatter;
exports.useI18nMessage = useI18nMessage;
