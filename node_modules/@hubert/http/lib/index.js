...
function useAction(initialData) {
  ...
  var _React$useState = React__default["default"].useState(defaultValue),
  ...
  var hasMsg = React__default["default"].useMemo(function () {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (configs !== null && configs !== void 0 && configs.cacheKey && !(configs !== null && configs !== void 0 && configs.cacheRefresh)) {
              data = shared.loadCache(configs === null || configs === void 0 ? void 0 : configs.cacheKey);
            ...
            // ? save cache if has cache config
              ...
              if (configs !== null && configs !== void 0 && configs.cacheKey && !usingCache) {
                shared.saveCache(configs.cacheKey, data, configs.cacheExpires);
              }
              return data;
            })
            // ? on success flow
            .then(function (data) {
              ...
              if (transformedData.status === 204 && configs !== null && configs !== void 0 && configs.forceErrorOnNoContent) {
                return Promise.reject({
                  message: shared.isPtBr() ? 'Nenhum item encontrado!' : 'No items found!',
                  status: transformedData.status
                });
              }
              try {
...
function useAct(request, configs, initialData) {
  ...
  var fn = React__default["default"].useCallback(function (props) {
    ...
    if (Array.isArray(value)) {
      ...
      if (configs !== null && configs !== void 0 && configs.arrayRepeat) {
        return "".concat(qs ? "".concat(qs, "&") : '').concat(value.map(function (x) {
          return "".concat(key, "=").concat(configs !== null && configs !== void 0 && configs.noEncodeURI ? x : configs !== null && configs !== void 0 && configs.doubleEncodeURI ? shared.doubleEncodeURI(x) : shared.simpleEncodeURI(x));
        }).join('&'));
      }
      return "".concat(qs ? "".concat(qs, "&") : '').concat(key, "=").concat(value.map(function (x) {
        return configs !== null && configs !== void 0 && configs.noEncodeURI ? x : configs !== null && configs !== void 0 && configs.doubleEncodeURI ? shared.doubleEncodeURI(x) : shared.simpleEncodeURI(x);
      }).join(','));
    }
    return "".concat(qs ? "".concat(qs, "&") : '').concat(key, "=").concat(configs !== null && configs !== void 0 && configs.noEncodeURI ? value : configs !== null && configs !== void 0 && configs.doubleEncodeURI ? shared.doubleEncodeURI(value) : shared.simpleEncodeURI(value));
  }, '');
  return result;
}
...
function urlParamsSerializer(url, params, configs) {
  ...
  return params ? Object.keys(params).reduce(function (acc, key) {
    return shared.replaceAll(acc, "{".concat(key, "}"), configs !== null && configs !== void 0 && configs.noEncodeURI ? params[key] : configs !== null && configs !== void 0 && configs.doubleEncodeURI ? shared.doubleEncodeURI(params[key]) : shared.simpleEncodeURI(params[key]));
  }, url) : url;
}
...
params, configs) {
  ...
  return Object.keys(params).reduce(function (acc, key) {
    ...
    var value = shared.parseStr(params[key]);
    if (!value) return acc;
...
var HttpResponseError = /*#__PURE__*/_createClass(function HttpResponseError(status) {
  ...
  var messages = shared.isPtBr() ? feedbackPTBR : feedbackENUS;
  this.status = status;
  this.results = data;
...
function dataNormalizer(data) {
  ...
  if (data) {
    return shared.camelCaseProps(data);
  }
  return [];
}
...
var HttpContext = /*#__PURE__*/React__default["default"].createContext(null);
var useHttp = function useHttp() {
  return React__default["default"].useContext(HttpContext);
};
function HttpProvider(_ref) {
  var configs = _ref.configs,
    children = _ref.children;
  var auth$1 = auth.useAuth();
  var value = React__default["default"].useMemo(function () {
    ...
    return configs !== null && configs !== void 0 && configs.localMode ? mockHttpClient({
      ...
      baseURL: '',
      accessToken: (configs === null || configs === void 0 ? void 0 : (_configs$tokenSeriali = configs.tokenSerializer) === null || _configs$tokenSeriali === void 0 ? void 0 : _configs$tokenSeriali.call(configs, auth$1 === null || auth$1 === void 0 ? void 0 : auth$1.accessToken, auth$1 === null || auth$1 === void 0 ? void 0 : auth$1.erpToken)) || (auth$1 === null || auth$1 === void 0 ? void 0 : auth$1.accessToken),
      onUnauthorized: auth$1 === null || auth$1 === void 0 ? void 0 : auth$1.handleUnauthorized
    });
  }, [configs, auth$1]);
  return /*#__PURE__*/React__default["default"].createElement(HttpContext.Provider, {
    value: value
  }, children);
}
function useService(factory) {
  var http = useHttp();
  var service = React__default["default"].useMemo(function () {
    return factory(http);
  }, [factory, http]);
  return service;
}
...
exports.fixProtocol = fixProtocol;
exports.headersSerializer = headersSerializer;
...
exports.urlParamsSerializer = urlParamsSerializer;
exports.useAct = useAct;
exports.useAction = useAction;
exports.useActionMock = useActionMock;
exports.useActionStateless = useActionStateless;
exports.useActionStatelessMock = useActionStatelessMock;
