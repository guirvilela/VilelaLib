  ...
  return comps.reduceRight(function (wrap, comp) {
    return function (_ref) {
      ...
      return /*#__PURE__*/ React.createElement(
        wrap,
        null,
        /*#__PURE__*/ React.createElement(comp, null, children)
      );
    };
  });
}
...
function usePagination(config) {
  var _React$useState = React.useState(config.initialPage || INITIALPAGE),
    _React$useState2 = _slicedToArray(_React$useState, 2),
  ...
  var _React$useState5 = React.useState(config.initialPageSize || PAGESIZE),
    _React$useState6 = _slicedToArray(_React$useState5, 2),
    pageSize = _React$useState6[0],
    setPageSize = _React$useState6[1];
  var totalItems = React.useMemo(
    function () {
      var _config$source;
...
function useQueue() {
  ...
  var addQueue = React.useCallback(
    function (task) {
  ...
  var runQueue = React.useCallback(
    /*#__PURE__*/ (function () {
